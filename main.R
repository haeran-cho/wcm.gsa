...
#' @param double.cusum if \code{double.cusum = TRUE}, the sequence of nested change point models is generated by the double CUSUM methodology; if not, the largest different in the CUSUMs is utilised
